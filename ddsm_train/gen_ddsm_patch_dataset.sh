python ddsm_train/sample_patches_combined.py\
    ...
    "data/curated_breast_imaging_ddsm/train_dat_mod/train"\
    "data/curated_breast_imaging_ddsm/train_dat_mod/val"\
    --nb-bkg=1\
    --nb-abn=1\
    --nb-hns=1
...
python ddsm_train/sample_patches_combined.py\
    ...
    "data/curated_breast_imaging_ddsm/train_dat_mod/test"\
    "data/curated_breast_imaging_ddsm/train_dat_mod/_folder_that_will_not_be_created"\
    --val-size=0\
    --nb-bkg=1\
    --nb-abn=1\
    --nb-hns=1
